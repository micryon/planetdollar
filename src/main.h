...
static const int64 DUST_SOFT_LIMIT = 100; // 0.25 PDR
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 10;   // 0.10 PDR mininput
/** No amount larger than this (in satoshi) is valid */

static const int64 MAX_MONEY = 645445094400000 * COIN; //fun and large number to last us a thousand years and more..
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 60; //roughly every 2 hours
