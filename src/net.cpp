...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PlanetDollar " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"planetdollar.org", "dnsseed.planetdollar.org"},
    {"planetdollar.org", "dnsseed2.planetdollar.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"planetdollar.org", "testnetseed.planetdollar.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PlanetDollar is probably already running."), addrBind.ToString().c_str());
        else
